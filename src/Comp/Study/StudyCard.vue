...
<script>
import StudyComponent1 from './StudyComponent1.vue';
import StudyComponent2 from './StudyComponent2.vue';
import StudyComponent3 from './StudyComponent3.vue';
export default {
  data() {
    return {
      active: 2,
      ...
      {
        title: "React",
        content: StudyComponent3,
    },
    {
        title: "Spring",
        content: StudyComponent2,
    },
    {
        title: "머신러닝",
        content: StudyComponent1,
    },
      ],
    };
  },
