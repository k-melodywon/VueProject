<template>
  ...
  <script>
  import ProjectComponent1 from './ProjectComponent1.vue';
  import ProjectComponent2 from './ProjectComponent2.vue';
  import ProjectComponent3 from './ProjectComponent3.vue';
  export default {
    data() {
      return {
        active: 2,
        ...
        cardData: [
          {
            title: "Spring",
            content: ProjectComponent3, // Replace with the appropriate component or content
          },
          {
            title: "Node.js를 활용한 쇼핑몰 사이트",
            content: ProjectComponent2, // Replace with the appropriate component or content
          },
          {
            title: "React를 기반으로 한 '가생이'프로젝트",
            content: ProjectComponent1, // Replace with the appropriate component or content
          },
        ],
      };
    },
